jsPlumb.ready(function() {
	...
	instance.batch(function() {
		...
		_addEndpoints("Window2", [ "LeftMiddle", "RightMiddle" ],
				[ "TopCenter" ]);
		_addEndpoints("Window3", [ "LeftMiddle", "RightMiddle" ],
				[ "TopCenter" ]);
		...
		// suspendedElement is ", connection.suspendedElement, " of type ",
